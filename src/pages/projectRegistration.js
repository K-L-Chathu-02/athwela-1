...
import { doc, setDoc } from "firebase/firestore";//C
import { getStorage, ref, uploadBytes, getDownloadURL } from "firebase/storage";//C
        ...
        <section className={styles.form_container}>
            ...
            <form action="#" method="post" enctype="multipart/form-data" onSubmit={handleProject}>
                ...
                <div className={styles.form_group}>
                    ...
                    <input type="file" id="images" name="images" accept="image/*" multiple required onChange={(e) => setImages(e.target.value)}/>
                </div>
                <div className={styles.form_group}>
                    <label htmlFor="evidence">Evidence Document:</label>
                    <input type="file" id="evidence" name="evidence" accept=".pdf,.doc,.docx" required onChange={(e) => setEvidence(e.target.value)}/>
                </div>
                <div className={styles.form_group}>
